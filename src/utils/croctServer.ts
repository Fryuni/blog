...
export class AstroCroct {
	private options: Pick<EvaluationOptions, keyof DynamicContentOptions & keyof EvaluationOptions>;

	private evaluationOptions: Omit<EvaluationOptions, keyof DynamicContentOptions>;
	...
	public async fetch<C extends JsonObject, I extends VersionedSlotId = VersionedSlotId>(
		slotId: I,
